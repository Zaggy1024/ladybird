...
static bool nearly_greater_than_or_equal(AK::Duration lhs, AK::Duration rhs)
{
...
static void expect_complete_file_is_fully_buffered(Fixture const& fixture)
{
    ...
    EXPECT(nearly_greater_than_or_equal(ranges[0].end, duration));
}
...
static Array fixtures {
    Fixture {
        ...
        { 256 * KiB, AK::Duration::from_milliseconds(1364), AK::Duration::from_milliseconds(1364) },
        { 1024 * KiB, AK::Duration::from_milliseconds(5460), AK::Duration::from_milliseconds(5460) },
    },
    Fixture {
    ...
    Fixture {
        ...
        { 96 * KiB, 476160, 3840, 48000 },
        { 160 * KiB, 780480, 35520, 48000 },
    },
    Fixture {
        "buffered-ranges/tone_flac.ogg"sv,
        { 96 * KiB, 354816, 13824, 44100 },
        { 160 * KiB, 594432, 4608, 44100 },
    },
    Fixture {
        "buffered-ranges/tone_vorbis.ogg"sv,
        { 256 * KiB, 3351552, 26624, 44100 },
        { 320 * KiB, 4201472, 32768, 44100 },
    },
};
