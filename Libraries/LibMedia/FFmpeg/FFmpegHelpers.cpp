...
#define ENUMERATE_CHANNEL_POSITIONS(C)                                              \
    ...
    C(Audio::Channel::WideLeft, AVChannel::AV_CHAN_WIDE_LEFT)                       \
    C(Audio::Channel::WideRight, AVChannel::AV_CHAN_WIDE_RIGHT)                     \
    C(Audio::Channel::DirectLeft, AVChannel::AV_CHAN_SURROUND_DIRECT_LEFT)          \
    C(Audio::Channel::DirectRight, AVChannel::AV_CHAN_SURROUND_DIRECT_RIGHT)
