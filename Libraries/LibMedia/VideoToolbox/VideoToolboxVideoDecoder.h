...
private:
    ...
    void note_decode_completed(i32 status, void* image_buffer, AK::Duration timestamp, AK::Duration duration);

    void enqueue_decoded_output_while_locked(void* image_buffer, AK::Duration timestamp, AK::Duration duration);
