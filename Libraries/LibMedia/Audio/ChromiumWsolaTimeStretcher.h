...
class ChromiumWsolaTimeStretcher final : public TimeStretcher {
public:
    static ErrorOr<NonnullOwnPtr<TimeStretcher>> create(u32 sample_rate, u8 channel_count);
    virtual ~ChromiumWsolaTimeStretcher() override;
...
private:
    ...
    explicit ChromiumWsolaTimeStretcher(NonnullOwnPtr<Impl>);
