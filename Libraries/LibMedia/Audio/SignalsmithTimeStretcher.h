...
class SignalsmithTimeStretcher final : public TimeStretcher {
public:
    static ErrorOr<NonnullOwnPtr<TimeStretcher>> create(u32 sample_rate, u8 channel_count);
    virtual ~SignalsmithTimeStretcher() override;
...
private:
    ...
    explicit SignalsmithTimeStretcher(NonnullOwnPtr<Impl>);
