...
constexpr StringView audio_channel_to_string(Channel channel)
{
    ...
    case Audio::Channel::WideLeft:
        return "WideLeft"sv;
    case Audio::Channel::WideRight:
        return "WideRight"sv;
    case Audio::Channel::DirectLeft:
        return "DirectLeft"sv;
    case Audio::Channel::DirectRight:
        return "DirectRight"sv;
