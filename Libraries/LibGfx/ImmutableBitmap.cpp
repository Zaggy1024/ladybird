...
bool ImmutableBitmap::ensure_sk_image(RefPtr<SkiaBackendContext> const& context) const
{
    ...
    // CPU fallback: convert YUV to RGBA8888 using yuv crate
    ...
    SkBitmap sk_bitmap;
    auto info = SkImageInfo::Make(bitmap->width(), bitmap->height(), kRGBA_8888_SkColorType, kPremul_SkAlphaType, color_space);
