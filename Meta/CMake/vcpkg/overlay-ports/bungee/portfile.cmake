...
# OVERLAY: build with debug info in the Release config so we can resolve assertions
# inside Bungee's binary. -fno-omit-frame-pointer keeps stack traces useful, and
# disabling NDEBUG keeps Bungee's own assert() calls active.
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DBUNGEE_PRESET=
    OPTIONS_RELEASE
        "-DCMAKE_C_FLAGS_RELEASE=-O2 -g -fno-omit-frame-pointer"
        "-DCMAKE_CXX_FLAGS_RELEASE=-O2 -g -fno-omit-frame-pointer"
)
vcpkg_cmake_install()
